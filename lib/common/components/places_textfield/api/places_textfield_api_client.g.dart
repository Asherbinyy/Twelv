...
class _PlacesRestApiClient implements PlacesRestApiClient {
  _PlacesRestApiClient(this._dio, {this.baseUrl}) {
  ...
  Future<PlacesAutocompleteResponse> autocomplete(
      apiKey, sessionToken, searchText, type, language) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PlacesAutocompleteResponse>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/autocomplete/json',
  ...
  Future<PlacesDetailsResponse> details(
      apiKey, sessionToken, placeId, language, fields) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'key': apiKey,
      r'sessiontoken': sessionToken,
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<PlacesDetailsResponse>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/details/json',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
