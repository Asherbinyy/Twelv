...
class _UsersRestClient implements UsersRestClient {
  ...
  Future<Profiles> getUsersRecommendations(
    ...
    final _result =
        await _dio.fetch<Map<String, dynamic>>(_setStreamType<Profiles>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<RecommendationsFilters> getFilters() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RecommendationsFilters>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<MatchedProfiles> getMatches() async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MatchedProfiles>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<HttpResponse<dynamic>> postSwipeAction(
    swipeAction, {
    required useCredit,
  }) async {
    const _extra = <String, dynamic>{};
    ...
    final _result =
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              '/users/swipe?use_credit=${useCredit}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
